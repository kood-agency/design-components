...
const buttonVariants = cva(
  "inline-flex box-border max-md:min-h-11 max-md:min-w-11 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-md border border-transparent text-sm font-semibold select-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 focus-visible:border-ring focus-visible:outline-solid focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-ring transition-colors duration-(--duration-enter) ease-standard motion-reduce:transition-none disabled:pointer-events-none disabled:border-input disabled:bg-secondary disabled:text-muted-foreground data-disabled:pointer-events-none data-disabled:border-input data-disabled:bg-secondary data-disabled:text-muted-foreground",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary-hover active:bg-primary-active focus-visible:border-primary-foreground focus-visible:outline-primary-foreground",
        secondary: "border-0 bg-secondary text-foreground hover:bg-muted active:bg-muted",
        outline: "border-input bg-card text-foreground hover:bg-secondary active:bg-muted",
        glass: "border-input kood-glass text-foreground",
        "glass-strong": "border-input kood-glass-strong text-foreground",
        ghost: "text-foreground-muted hover:bg-secondary hover:text-foreground active:bg-muted",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive active:bg-destructive focus-visible:border-destructive-foreground focus-visible:outline-destructive-foreground",
      ...
      size: {
        ...
        "icon-lg": "size-11 max-md:min-w-11",
      },
    },
    defaultVariants: {
      variant: "default",
